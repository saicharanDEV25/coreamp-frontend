    ...
    <footer className="footer">
      ...
      <div className="container footer-grid">
        ...
        <div className="footer-column footer-contact">
          ...
          <span>
            <MapPin size={15} />
            {COREAMP_CONTACT.office}
          </span>

          <a
            href={`tel:${COREAMP_CONTACT.phoneHref}`}
          >
            <Phone size={15} />
            {COREAMP_CONTACT.phoneDisplay}
          </a>

          <a
            href={`mailto:${COREAMP_CONTACT.email}`}
          >
            <Mail size={15} />
            {COREAMP_CONTACT.email}
          </a>
        </div>
      </div>
